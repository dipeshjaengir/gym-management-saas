...
export const PaymentsTracker: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <form id="record-payment-form" onSubmit={handleLogPayment} className="space-y-4">
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {(['upi', 'cash', 'card'] as const).map((method) => (
                <button
                  ...
                  className={`h-11 rounded-xl border text-xs font-semibold uppercase transition-all cursor-pointer flex items-center justify-center ${
      ...
      <ResponsiveModal
        ...
        footer={
          receipt && (
            <div className="flex flex-wrap gap-2 w-full print:hidden">
              <button
                onClick={handleShareWhatsApp}
                className="flex-grow h-11 bg-emerald-650 hover:bg-emerald-600 text-white text-xs font-semibold rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-sm min-h-[44px]"
              >
                <MessageCircle className="w-4 h-4" /> Share WhatsApp
              </button>
              <button
                onClick={handleShareEmail}
                className="flex-grow h-11 bg-indigo-650 hover:bg-indigo-600 text-white text-xs font-semibold rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-sm min-h-[44px]"
              >
                <Mail className="w-4 h-4" /> Send Email
              </button>
              <button
                onClick={handlePrint}
                className="flex-grow h-11 bg-primary hover:bg-primary/95 text-primary-foreground text-xs font-semibold rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-sm min-h-[44px]"
              >
        ...
        {loadingReceipt || !receipt ? (
          ...
          <div id="printable-receipt" className="space-y-6 text-foreground font-sans p-2">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest bg-muted/45 px-3 py-1 rounded-full inline-block">
            ...
            {/* Receipt Meta */}
            <div className="grid grid-cols-2 gap-4 p-3 bg-muted/30 border border-border rounded-xl text-xs">
              <div>
            ...
            {/* Details Block */}
            <div className="border border-border border-collapse rounded-xl overflow-hidden text-xs">
              <div className="grid grid-cols-2 bg-muted/40 p-2.5 font-semibold text-muted-foreground border-b border-border uppercase text-[9px] tracking-wide">
                <span>Description</span>
                <span className="text-right">Amount</span>
              </div>
              <div className="grid grid-cols-2 p-3 font-medium border-b border-border">
              ...
              <div className="grid grid-cols-2 p-3 text-muted-foreground">
                ...
                <span className="text-right font-bold text-rose-450">₹{receipt.pendingAmount}.00</span>
              </div>
            </div>
