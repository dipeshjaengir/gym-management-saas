...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-card p-8 rounded-3xl shadow-2xl relative border border-border">
        <div className="flex flex-col items-center mb-8">
          <Logo size={56} className="mb-3" />
          <h2 className="font-extrabold text-2xl tracking-tight text-foreground">Access Your Console</h2>
